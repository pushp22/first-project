...
const ProductList = () => {
    ...
    // const [products, setProducts] = useState([]);  /* hooks , destructuring assignments*/
    ...
    }, []);  */ /*  if [] empty, useeffect run once, when components mount */
    ...
    return (
        <div className="container mx-auto pb-24">
            ...
            <div className="grid grid-cols-5 my-8 gap-24">
                {
                    products.map(product => <Product key={product._id} product={product} />)  /* map works as a loop , key is property*/
                }
                {/* <Product />*/}
            </div>
        </div>
